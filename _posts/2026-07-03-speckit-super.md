...
description: "分别拆解 Spec Kit 与 Superpowers 的并行设计，再讨论两套独立工作流融合时的语义差异、控制权与工程挑战。"
---
...
- [Spec Kit: `speckit-tasks`](https://github.com/github/spec-kit/blob/main/templates/commands/tasks.md)
- [Spec Kit: `speckit-implement`](https://github.com/github/spec-kit/blob/main/templates/commands/implement.md)
- [Superpowers: `dispatching-parallel-agents`](https://github.com/obra/superpowers/tree/main/skills/dispatching-parallel-agents)
- [Superpowers: `subagent-driven-development`](https://github.com/obra/superpowers/tree/main/skills/subagent-driven-development)
- [Superpowers: `executing-plans`](https://github.com/obra/superpowers/tree/main/skills/executing-plans)
